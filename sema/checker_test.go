...
func TestReferenceSubtyping(t *testing.T) {
	...
	tests := []struct {
		...
		{intRef(mapAccess), anyStructRef(mapAccess), false},
		...
		{intRef(containedMapAccess), anyStructRef(containedMapAccess), false},
		...
		{intRef(yzConjunction), intRef(mapAccess), false},
