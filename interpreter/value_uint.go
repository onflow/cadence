...
func (v UIntValue) Negate(NumberValueArithmeticContext, LocationRange) NumberValue {
	panic(errors.NewUnreachableError())
}
...
func (v UIntValue) HashInput(_ common.Gauge, _ LocationRange, scratch []byte) []byte {
