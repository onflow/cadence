...
func (v Int32Value) Negate(context NumberValueArithmeticContext) NumberValue {
	// INT32-C
	if v == math.MinInt32 {
		panic(&OverflowError{})
	}
...
func (v Int32Value) Plus(context NumberValueArithmeticContext, other NumberValue) NumberValue {
...
func (v Int32Value) Minus(context NumberValueArithmeticContext, other NumberValue) NumberValue {
	o, ok := other.(Int32Value)
	if !ok {
		panic(&InvalidOperandsError{
...
func (v Int32Value) Mod(context NumberValueArithmeticContext, other NumberValue) NumberValue {
	o, ok := other.(Int32Value)
	if !ok {
		panic(&InvalidOperandsError{
...
func (v Int32Value) Mul(context NumberValueArithmeticContext, other NumberValue) NumberValue {
	o, ok := other.(Int32Value)
	if !ok {
		panic(&InvalidOperandsError{
...
func (v Int32Value) Div(context NumberValueArithmeticContext, other NumberValue) NumberValue {
	o, ok := other.(Int32Value)
	if !ok {
		panic(&InvalidOperandsError{
...
func (v Int32Value) Less(context ValueComparisonContext, other ComparableValue) BoolValue {
	o, ok := other.(Int32Value)
	if !ok {
		panic(&InvalidOperandsError{
...
func (v Int32Value) GetMethod(context MemberAccessibleContext, name string, accessedReference ReferenceValue) FunctionValue {
