...
func TestInterpretMemoryMeteringArray(t *testing.T) {
	...
	t.Run("contains", func(t *testing.T) {
		...
		assert.Equal(t, ifCompile[uint64](2, 9), meter.getMemory(common.MemoryKindPrimitiveStaticType))
	})
...
func TestInterpretMemoryMeteringComposite(t *testing.T) {
	...
	t.Run("creation", func(t *testing.T) {
		...
		assert.Equal(t, uint64(32), meter.getMemory(common.MemoryKindAtreeMapPreAllocatedElement))
		assert.Equal(t, ifCompile[uint64](2, 12), meter.getMemory(common.MemoryKindCompositeStaticType))
...
func TestInterpretMemoryMeteringStaticTypeConversion(t *testing.T) {
	...
	t.Run("primitive static types", func(t *testing.T) {
		...
		assert.Equal(t, uint64(1), meter.getMemory(common.MemoryKindDictionarySemaType))
		assert.Equal(t, uint64(2), meter.getMemory(common.MemoryKindVariableSizedSemaType))
		assert.Equal(t, uint64(1), meter.getMemory(common.MemoryKindConstantSizedSemaType))
		assert.Equal(t, uint64(2), meter.getMemory(common.MemoryKindIntersectionSemaType))
		assert.Equal(t, uint64(2), meter.getMemory(common.MemoryKindReferenceSemaType))
		assert.Equal(t, uint64(1), meter.getMemory(common.MemoryKindCapabilitySemaType))
		assert.Equal(t, uint64(1), meter.getMemory(common.MemoryKindOptionalSemaType))
	})
}
