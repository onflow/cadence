...
func TestInterpretMemoryMeteringArray(t *testing.T) {
	...
	t.Run("insert with packing", func(t *testing.T) {
		...
		assert.Equal(t, uint64(13), meter.getMemory(common.MemoryKindPrimitiveStaticType))
	...
	t.Run("insert many", func(t *testing.T) {
		...
		assert.Equal(t, uint64(37), meter.getMemory(common.MemoryKindPrimitiveStaticType))
...
func TestInterpretMemoryMeteringDictionary(t *testing.T) {
	...
	t.Run("insert", func(t *testing.T) {
		...
		assert.Equal(t, ifCompile[uint64](15, 16), meter.getMemory(common.MemoryKindPrimitiveStaticType))
