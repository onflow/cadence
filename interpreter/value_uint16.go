...
func (v UInt16Value) Negate(NumberValueArithmeticContext) NumberValue {
	panic(errors.NewUnreachableError())
}

func (v UInt16Value) Plus(context NumberValueArithmeticContext, other NumberValue) NumberValue {
...
func (v UInt16Value) Minus(context NumberValueArithmeticContext, other NumberValue) NumberValue {
	o, ok := other.(UInt16Value)
	if !ok {
		panic(&InvalidOperandsError{
...
func (v UInt16Value) Mod(context NumberValueArithmeticContext, other NumberValue) NumberValue {
	o, ok := other.(UInt16Value)
	if !ok {
		panic(&InvalidOperandsError{
...
func (v UInt16Value) Mul(context NumberValueArithmeticContext, other NumberValue) NumberValue {
	o, ok := other.(UInt16Value)
	if !ok {
		panic(&InvalidOperandsError{
...
func (v UInt16Value) Div(context NumberValueArithmeticContext, other NumberValue) NumberValue {
	o, ok := other.(UInt16Value)
	if !ok {
		panic(&InvalidOperandsError{
...
func (v UInt16Value) Less(context ValueComparisonContext, other ComparableValue) BoolValue {
	o, ok := other.(UInt16Value)
	if !ok {
		panic(&InvalidOperandsError{
...
func (v UInt16Value) GetMethod(context MemberAccessibleContext, name string, accessedReference ReferenceValue) FunctionValue {
