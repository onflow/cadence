...
type HashableValue interface {
	Value
	HashInput(gauge common.Gauge, locationRange LocationRange, scratch []byte) []byte
}

func newHashInputProvider(gauge common.Gauge, locationRange LocationRange) atree.HashInputProvider {
