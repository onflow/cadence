...
func (v Int16Value) Negate(context NumberValueArithmeticContext) NumberValue {
	// INT32-C
	if v == math.MinInt16 {
		panic(&OverflowError{})
	}
...
func (v Int16Value) Plus(context NumberValueArithmeticContext, other NumberValue) NumberValue {
...
func (v Int16Value) Minus(context NumberValueArithmeticContext, other NumberValue) NumberValue {
	o, ok := other.(Int16Value)
	if !ok {
		panic(&InvalidOperandsError{
...
func (v Int16Value) Mod(context NumberValueArithmeticContext, other NumberValue) NumberValue {
	o, ok := other.(Int16Value)
	if !ok {
		panic(&InvalidOperandsError{
...
func (v Int16Value) Mul(context NumberValueArithmeticContext, other NumberValue) NumberValue {
	o, ok := other.(Int16Value)
	if !ok {
		panic(&InvalidOperandsError{
...
func (v Int16Value) Div(context NumberValueArithmeticContext, other NumberValue) NumberValue {
	o, ok := other.(Int16Value)
	if !ok {
		panic(&InvalidOperandsError{
...
func (v Int16Value) Less(context ValueComparisonContext, other ComparableValue) BoolValue {
	o, ok := other.(Int16Value)
	if !ok {
		panic(&InvalidOperandsError{
...
func (v Int16Value) GetMember(context MemberAccessibleContext, name string, memberKind common.DeclarationKind) Value {
	return GetMember(
		context,
		v,
		name,
...
func (v Int16Value) GetMethod(context MemberAccessibleContext, name string) FunctionValue {
	return getNumberValueFunctionMember(context, v, name, sema.Int16Type)
}
...
func (Int16Value) CanCopyNonRefSimple() bool {
	return true
}

func (v Int16Value) CopyNonRefSimple() (atree.Storable, error) {
