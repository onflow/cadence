...
func NewAccountKeysValue(
	...
	computeMethod := func(name string, _ MemberAccessibleContext, accessedReference ReferenceValue) FunctionValue {
		...
		case sema.Account_KeysTypeAddFunctionName:
			return addFunction(accountKeys, accessedReference)
		case sema.Account_KeysTypeGetFunctionName:
			return getFunction(accountKeys, accessedReference)
		case sema.Account_KeysTypeRevokeFunctionName:
			return revokeFunction(accountKeys, accessedReference)
		case sema.Account_KeysTypeForEachFunctionName:
			return forEachFunction(accountKeys, accessedReference)
		}
