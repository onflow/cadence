...
require (
	...
	github.com/onflow/cadence v0.24.0-beta.1
...
replace github.com/ipfs/go-ipfs-blockstore => github.com/ipfs/go-ipfs-blockstore v1.2.0

replace github.com/onflow/flow-go => github.com/onflow/flow-go v0.26.2
