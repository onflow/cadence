...
//
//		rt := runtime.newTestInterpreterRuntime()
//
//		// language=cadence
//		contract := `
//          pub contract Test {
...
//		}
//
//		nextTransactionLocation := runtime.newTransactionLocationGenerator()
//
//		// Deploy contract
//
