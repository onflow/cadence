...
func TestInterpretAttachmentGetFunction(t *testing.T) {
	...
	t.Run("access(contract)", func(t *testing.T) {
        ...
        fun test(): ((): Int)? {
            var r <- C.getR()
            let ret = r[C.A]!.getFunction<(():Int)>("x")
            destroy r
            return ret
        }
	...
	t.Run("access(contract) still not ok ", func(t *testing.T) {
...
func TestInterpretAttachmentGetField(t *testing.T) {
	...
	t.Run("access control priv", func(t *testing.T) {
	...
	t.Run("access control priv still not ok", func(t *testing.T) {
	...
	t.Run("access control contract", func(t *testing.T) {
	...
	t.Run("access control contract still not ok", func(t *testing.T) {
