...
func _() {
	...
	_ = x[PrimitiveStaticTypeAccountKey-98]
	_ = x[PrimitiveStaticTypePublicKey-99]
}

const _PrimitiveStaticType_name = ""
...
var _PrimitiveStaticType_map = map[PrimitiveStaticType]string{
	...
	98: _PrimitiveStaticType_name[371:381],
	99: _PrimitiveStaticType_name[381:390],
}
