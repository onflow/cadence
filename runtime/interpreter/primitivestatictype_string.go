...
func _() {
	...
	_ = x[PrimitiveStaticTypeAccountKey-102]
	_ = x[PrimitiveStaticTypePublicKey-103]
	_ = x[PrimitiveStaticTypeSignatureAlgorithm-104]
	_ = x[PrimitiveStaticTypeHashAlgorithm-105]
	_ = x[PrimitiveStaticTypePublicAccountKeys-106]
	_ = x[PrimitiveStaticTypeAuthAccountKeys-107]
}

const _PrimitiveStaticType_name = ""
...
var _PrimitiveStaticType_map = map[PrimitiveStaticType]string{
	...
	102: _PrimitiveStaticType_name[371:381],
	103: _PrimitiveStaticType_name[381:390],
	104: _PrimitiveStaticType_name[390:408],
	105: _PrimitiveStaticType_name[408:421],
	106: _PrimitiveStaticType_name[421:438],
	107: _PrimitiveStaticType_name[438:453],
}
