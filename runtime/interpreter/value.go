...
// AccountCapabilityValue

type AccountCapabilityValue struct {
	Address AddressValue
}

func NewUnmeteredAccountCapabilityValue(address AddressValue) *AccountCapabilityValue {
	return &AccountCapabilityValue{
		Address: address,
	}
}

func NewAccountCapabilityValue(
	memoryGauge common.MemoryGauge,
	address AddressValue,
) *AccountCapabilityValue {
	// Constant because its constituents are already metered.
	common.UseMemory(memoryGauge, common.AccountCapabilityValueMemoryUsage)
	return NewUnmeteredAccountCapabilityValue(address)
}

var _ Value = &AccountCapabilityValue{}
var _ atree.Storable = &AccountCapabilityValue{}
var _ EquatableValue = &AccountCapabilityValue{}
var _ MemberAccessibleValue = &AccountCapabilityValue{}

func (*AccountCapabilityValue) IsValue() {}

func (v *AccountCapabilityValue) Accept(interpreter *Interpreter, visitor Visitor) {
	visitor.VisitAccountCapabilityValue(interpreter, v)
}

func (v *AccountCapabilityValue) Walk(_ *Interpreter, walkChild func(Value)) {
	walkChild(v.Address)
}
...
func (v *AccountCapabilityValue) StaticType(inter *Interpreter) StaticType {
	return NewCapabilityStaticType(
		inter,
...
func (v *AccountCapabilityValue) IsImportable(_ *Interpreter) bool {
	return false
}

func (v *AccountCapabilityValue) String() string {
	return v.RecursiveString(SeenReferences{})
}

func (v *AccountCapabilityValue) RecursiveString(seenReferences SeenReferences) string {
	return format.AccountCapability(
		v.Address.RecursiveString(seenReferences),
	)
}

func (v *AccountCapabilityValue) MeteredString(memoryGauge common.MemoryGauge, seenReferences SeenReferences) string {
	common.UseMemory(memoryGauge, common.AccountCapabilityValueStringMemoryUsage)
...
func (v *AccountCapabilityValue) GetMember(interpreter *Interpreter, _ LocationRange, name string) Value {
	switch name {
	case sema.CapabilityTypeBorrowField:
		// TODO:
		panic("TODO")
...
func (*AccountCapabilityValue) RemoveMember(_ *Interpreter, _ LocationRange, _ string) Value {
	// Capabilities have no removable members (fields / functions)
	panic(errors.NewUnreachableError())
}

func (*AccountCapabilityValue) SetMember(_ *Interpreter, _ LocationRange, _ string, _ Value) {
	// Capabilities have no settable members (fields / functions)
	panic(errors.NewUnreachableError())
}

func (v *AccountCapabilityValue) ConformsToStaticType(
	_ *Interpreter,
	_ LocationRange,
	_ TypeConformanceResults,
) bool {
...
func (v *AccountCapabilityValue) Equal(interpreter *Interpreter, locationRange LocationRange, other Value) bool {
	otherCapability, ok := other.(*AccountCapabilityValue)
	if !ok {
		return false
	}
...
func (*AccountCapabilityValue) IsStorable() bool {
	return true
}

func (v *AccountCapabilityValue) Storable(
	storage atree.SlabStorage,
	address atree.Address,
	maxInlineSize uint64,
) (atree.Storable, error) {
...
func (*AccountCapabilityValue) NeedsStoreTo(_ atree.Address) bool {
	return false
}

func (*AccountCapabilityValue) IsResourceKinded(_ *Interpreter) bool {
	return false
}

func (v *AccountCapabilityValue) Transfer(
	interpreter *Interpreter,
	_ LocationRange,
	_ atree.Address,
	remove bool,
...
func (v *AccountCapabilityValue) Clone(interpreter *Interpreter) Value {
	return &AccountCapabilityValue{
		Address: v.Address.Clone(interpreter).(AddressValue),
	}
}

func (v *AccountCapabilityValue) DeepRemove(interpreter *Interpreter) {
	v.Address.DeepRemove(interpreter)
}

func (v *AccountCapabilityValue) ByteSize() uint32 {
	return mustStorableSize(v)
}

func (v *AccountCapabilityValue) StoredValue(_ atree.SlabStorage) (atree.Value, error) {
	return v, nil
}

func (v *AccountCapabilityValue) ChildStorables() []atree.Storable {
	return []atree.Storable{
		v.Address,
	}
}
