...
on-chain, graphics and video content are stored off-chain. Cadence provides [utility views](../flow#flow-nft#overview#list-of-common-views)
...
NFT metadata on Flow opens the door to exciting new possibilities that help builder to innovate. Check out this
recent [case study](https://flow.com/post/flovatar-nft-flow-blockchain-case-study) where a community partner
leveraged SVG on-chain NFT metadata to make combined 2D + 3D versions of their PFPs, all on-chain inside the NFT
metadata!
