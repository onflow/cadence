...
ill require a different approach in Cadence. The design of Cadence is intentionally different,
...
that exploit those advantages and also describes some ways of approaching
