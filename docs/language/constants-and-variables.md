...
a value and [type](https://docs.onflow.org/cadence/language/type-safety) to an identifier.
...
an optional [type annotation](https://docs.onflow.org/cadence/language/type-annotations), an equals sign `=`,
