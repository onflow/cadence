...
a value and [type](https://github.com/onflow/cadence/blob/master/docs/language/type-safety.md) to an identifier.
...
an optional [type annotation](https://github.com/onflow/cadence/blob/master/docs/language/type-annotations.md), an equals sign `=`,
