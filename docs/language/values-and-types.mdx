...
// Declare an address with the string representation without the "0x" prefix.
let addressFromStringWithoutPrefix: Address = Address.fromString("436164656E636521")

// Invalid: Provided value is a valid hex string. The function panics.
let invalidAddressForInvalidHex: Address = Address.fromString("0xZZZ")

// Invalid: Provided value is larger than 64 bits. The function panics.
