...
which represents the publicly available portion of an account.
  ...
  struct PublicAccount {
      ...
      // Storage iteration  
      fun forEachPublic(_ function: ((PublicPath, Type): Bool)): Void
...
to the `prepare` phase of the transaction.
  ...
  struct AuthAccount {
      ...
      // Storage iteration  
      fun forEachPublic(_ function: ((PublicPath, Type): Bool)): Void
      fun forEachPrivate(_ function: ((PrivatePath, Type): Bool)): Void
      fun forEachStored(_ function: ((StoragePath, Type): Bool)): Void
