...
Resources have an impicit unique identifier associated with them,
all resources have a predeclared public field `let uuid: UInt64`.

This identifier will be automatically set when the resource is created,
...
// Get each resource's unique identifiier
let id1 = r1.uuid
let id2 = r2.uuid
