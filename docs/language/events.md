...
a [function declaration](https://docs.onflow.org/cadence/language/functions/#function-declarations);
...
Events can only be declared within a [contract](https://docs.onflow.org/cadence/language/contracts) body.
