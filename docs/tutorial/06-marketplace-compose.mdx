...
[The marketplace setup guide](/cadence/tutorial/05-marketplace-setup/) shows you how to get the playground set up to do this tutorial.
...
**Before proceeding with this tutorial**, you need to complete the [Fungible Tokens](/cadence/tutorial/03-fungible-tokens/)
and [Non-Fungible Token](/cadence/tutorial/04-non-fungible-tokens/) tutorials
...
If you haven't already, please perform the steps in the [marketplace setup guide](/cadence/tutorial/05-marketplace-setup/)
...
that was explained in [Non-Fungible Tokens](/cadence/tutorial/04-non-fungible-tokens), with a few differences and additions:
...
[We have covered capabilities in previous tutorials(/cadence/tutorial/03-fungible-tokens/#ensuring-security-in-public-capability-security)],
...
Then, users can get that capability if it was created [in a public path](https://docs.onflow.org/cadence/language/accounts/#paths),
...
Check out the [Kitty Hats tutorial](/cadence/tutorial/07-resources-compose/) for a little more exploration of this concept.
...
Check out the [Kitty Hats tutorial!](/cadence/tutorial/07-resources-compose/)
