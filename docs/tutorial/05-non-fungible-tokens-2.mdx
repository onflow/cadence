...
In the [last tutorial](/cadence/tutorial/05-non-fungible-tokens-1),
...
You can see an example of this in the [Marketplace tutorial.](/cadence/tutorial/06-marketplace-compose/)
