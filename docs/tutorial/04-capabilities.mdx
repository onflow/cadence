...
This tutorial builds on the [previous `Resource` tutorial](/cadence/tutorial/03-resources).
...
You'll learn how to interact with resources using [capabilities](https://docs.onflow.org/cadence/language/capability-based-access-control/)
...
For a more detailed breakdown of the contract, have a look at the [previous tutorial](/cadence/tutorial/03-resources).
...
Next you use that link to borrow a [reference](https://docs.onflow.org/cadence/language/references/)
...
Most of the [account storage API](https://docs.onflow.org/cadence/language/accounts/#account-storage-api)
...
Have a look at the [capability-based access control page](https://docs.onflow.org/cadence/language/capability-based-access-control/) to find out more about what you can do with capabilities.
