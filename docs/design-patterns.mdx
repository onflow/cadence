...
Remember that if they do fit they may not be the right solution for a given situation,
and they are not meant to be a set of prescriptions to be followed exclusively even where a better solution represents itself.
