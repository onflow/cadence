...
func TestEncodeInt(t *testing.T) {
	testAllEncode(t, []encodeTest{
		...
		},
		{
			...
			cadence.NewIntFromBig(new(big.Int).Sub(sema.Int256TypeMinInt, big.NewInt(10))),
			`{"type":"Int","value":"-57896044618658097711785492504343953926634992332820282019728792003956564819978"}`,
		},
		{
			"LargerThanMaxUInt256",
			cadence.NewIntFromBig(new(big.Int).Add(sema.UInt256TypeMaxInt, big.NewInt(10))),
...
func TestEncodeUInt(t *testing.T) {
	testAllEncode(t, []encodeTest{
		...
		{
			"LargerThanMaxUInt256",
			cadence.NewUIntFromBig(new(big.Int).Add(sema.UInt256TypeMaxInt, big.NewInt(10))),
