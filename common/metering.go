...
var (
	...
	InstructionReturnComputationUsage              = NewConstantComputationUsage(ComputationKindInstructionReturn)
	InstructionReturnValueComputationUsage         = NewConstantComputationUsage(ComputationKindInstructionReturnValue)
	InstructionJumpComputationUsage                = NewConstantComputationUsage(ComputationKindInstructionJump)
	InstructionJumpIfFalseComputationUsage         = NewConstantComputationUsage(ComputationKindInstructionJumpIfFalse)
	InstructionJumpIfTrueComputationUsage          = NewConstantComputationUsage(ComputationKindInstructionJumpIfTrue)
	InstructionJumpIfNilComputationUsage           = NewConstantComputationUsage(ComputationKindInstructionJumpIfNil)
	InstructionAddComputationUsage                 = NewConstantComputationUsage(ComputationKindInstructionAdd)
	InstructionSubtractComputationUsage            = NewConstantComputationUsage(ComputationKindInstructionSubtract)
	InstructionMultiplyComputationUsage            = NewConstantComputationUsage(ComputationKindInstructionMultiply)
	InstructionDivideComputationUsage              = NewConstantComputationUsage(ComputationKindInstructionDivide)
	InstructionModComputationUsage                 = NewConstantComputationUsage(ComputationKindInstructionMod)
	InstructionNegateComputationUsage              = NewConstantComputationUsage(ComputationKindInstructionNegate)
	InstructionBitwiseOrComputationUsage           = NewConstantComputationUsage(ComputationKindInstructionBitwiseOr)
	InstructionBitwiseAndComputationUsage          = NewConstantComputationUsage(ComputationKindInstructionBitwiseAnd)
	InstructionBitwiseXorComputationUsage          = NewConstantComputationUsage(ComputationKindInstructionBitwiseXor)
	InstructionBitwiseLeftShiftComputationUsage    = NewConstantComputationUsage(ComputationKindInstructionBitwiseLeftShift)
	InstructionBitwiseRightShiftComputationUsage   = NewConstantComputationUsage(ComputationKindInstructionBitwiseRightShift)
	InstructionLessComputationUsage                = NewConstantComputationUsage(ComputationKindInstructionLess)
	InstructionGreaterComputationUsage             = NewConstantComputationUsage(ComputationKindInstructionGreater)
	InstructionLessOrEqualComputationUsage         = NewConstantComputationUsage(ComputationKindInstructionLessOrEqual)
	InstructionGreaterOrEqualComputationUsage      = NewConstantComputationUsage(ComputationKindInstructionGreaterOrEqual)
	InstructionEqualComputationUsage               = NewConstantComputationUsage(ComputationKindInstructionEqual)
	InstructionNotEqualComputationUsage            = NewConstantComputationUsage(ComputationKindInstructionNotEqual)
	...
	InstructionForceCastComputationUsage           = NewConstantComputationUsage(ComputationKindInstructionForceCast)
	InstructionDerefComputationUsage               = NewConstantComputationUsage(ComputationKindInstructionDeref)
	InstructionTrueComputationUsage                = NewConstantComputationUsage(ComputationKindInstructionTrue)
	InstructionFalseComputationUsage               = NewConstantComputationUsage(ComputationKindInstructionFalse)
	InstructionNilComputationUsage                 = NewConstantComputationUsage(ComputationKindInstructionNil)
	InstructionNewComputationUsage                 = NewConstantComputationUsage(ComputationKindInstructionNew)
	InstructionNewPathComputationUsage             = NewConstantComputationUsage(ComputationKindInstructionNewPath)
	InstructionNewArrayComputationUsage            = NewConstantComputationUsage(ComputationKindInstructionNewArray)
	InstructionNewDictionaryComputationUsage       = NewConstantComputationUsage(ComputationKindInstructionNewDictionary)
	InstructionNewRefComputationUsage              = NewConstantComputationUsage(ComputationKindInstructionNewRef)
	InstructionNewClosureComputationUsage          = NewConstantComputationUsage(ComputationKindInstructionNewClosure)
	InstructionGetConstantComputationUsage         = NewConstantComputationUsage(ComputationKindInstructionGetConstant)
	InstructionGetLocalComputationUsage            = NewConstantComputationUsage(ComputationKindInstructionGetLocal)
	InstructionSetLocalComputationUsage            = NewConstantComputationUsage(ComputationKindInstructionSetLocal)
	InstructionGetUpvalueComputationUsage          = NewConstantComputationUsage(ComputationKindInstructionGetUpvalue)
	InstructionSetUpvalueComputationUsage          = NewConstantComputationUsage(ComputationKindInstructionSetUpvalue)
	InstructionGetGlobalComputationUsage           = NewConstantComputationUsage(ComputationKindInstructionGetGlobal)
	InstructionSetGlobalComputationUsage           = NewConstantComputationUsage(ComputationKindInstructionSetGlobal)
	InstructionGetFieldComputationUsage            = NewConstantComputationUsage(ComputationKindInstructionGetField)
	InstructionRemoveFieldComputationUsage         = NewConstantComputationUsage(ComputationKindInstructionRemoveField)
	InstructionSetFieldComputationUsage            = NewConstantComputationUsage(ComputationKindInstructionSetField)
	InstructionSetIndexComputationUsage            = NewConstantComputationUsage(ComputationKindInstructionSetIndex)
	InstructionGetIndexComputationUsage            = NewConstantComputationUsage(ComputationKindInstructionGetIndex)
	InstructionRemoveIndexComputationUsage         = NewConstantComputationUsage(ComputationKindInstructionRemoveIndex)
	InstructionInvokeComputationUsage              = NewConstantComputationUsage(ComputationKindInstructionInvoke)
	InstructionInvokeMethodStaticComputationUsage  = NewConstantComputationUsage(ComputationKindInstructionInvokeMethodStatic)
	InstructionInvokeMethodDynamicComputationUsage = NewConstantComputationUsage(ComputationKindInstructionInvokeMethodDynamic)
	InstructionDropComputationUsage                = NewConstantComputationUsage(ComputationKindInstructionDrop)
	InstructionDupComputationUsage                 = NewConstantComputationUsage(ComputationKindInstructionDup)
	InstructionIteratorComputationUsage            = NewConstantComputationUsage(ComputationKindInstructionIterator)
	InstructionIteratorHasNextComputationUsage     = NewConstantComputationUsage(ComputationKindInstructionIteratorHasNext)
	InstructionIteratorNextComputationUsage        = NewConstantComputationUsage(ComputationKindInstructionIteratorNext)
	InstructionEmitEventComputationUsage           = NewConstantComputationUsage(ComputationKindInstructionEmitEvent)
