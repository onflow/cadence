...
func _() {
	...
	_ = x[MemoryKindArrayIterator-204]
	_ = x[MemoryKindDictionaryKeyIterator-205]
	_ = x[MemoryKindStringIterator-206]
	_ = x[MemoryKindGoSliceLength-207]
	_ = x[MemoryKindCompiler-208]
	_ = x[MemoryKindCompilerGlobal-209]
	_ = x[MemoryKindCompilerLocal-210]
	_ = x[MemoryKindCompilerConstant-211]
	_ = x[MemoryKindCompilerFunction-212]
	_ = x[MemoryKindCompilerInstruction-213]
	_ = x[MemoryKindCompilerBBQProgram-214]
	_ = x[MemoryKindCompilerBBQConstant-215]
	_ = x[MemoryKindCompilerBBQFunction-216]
	_ = x[MemoryKindCompilerBBQImport-217]
	_ = x[MemoryKindCompilerBBQVariable-218]
	_ = x[MemoryKindCompilerBBQContract-219]
	_ = x[MemoryKindImplicitReferenceVMValue-220]
	_ = x[MemoryKindBoundFunctionVMValue-221]
	_ = x[MemoryKindLast-222]
}

const _MemoryKind_name = ""

var _MemoryKind_index = [...]uint16{0, 7, 19, 30, 44, 55, 69, 88, 106, 130, 143, 152, 161, 176, 197, 220, 244, 261, 279, 285, 305, 319, 351, 383, 401, 423, 448, 464, 484, 507, 534, 550, 569, 588, 607, 630, 653, 673, 697, 715, 737, 763, 789, 808, 828, 846, 862, 882, 898, 916, 937, 956, 971, 989, 1010, 1033, 1055, 1081, 1100, 1122, 1144, 1168, 1194, 1218, 1244, 1265, 1286, 1310, 1334, 1354, 1374, 1390, 1406, 1428, 1463, 1483, 1502, 1533, 1562, 1591, 1612, 1637, 1649, 1665, 1685, 1702, 1721, 1742, 1758, 1777, 1803, 1831, 1859, 1878, 1905, 1932, 1952, 1975, 1996, 2011, 2020, 2035, 2040, 2048, 2064, 2081, 2095, 2105, 2115, 2125, 2134, 2144, 2154, 2161, 2171, 2179, 2184, 2197, 2206, 2219, 2232, 2249, 2257, 2264, 2278, 2293, 2303, 2322, 2342, 2363, 2383, 2405, 2430, 2459, 2478, 2494, 2516, 2533, 2552, 2578, 2595, 2614, 2628, 2645, 2658, 2677, 2689, 2700, 2715, 2728, 2743, 2757, 2772, 2789, 2803, 2816, 2832, 2849, 2869, 2884, 2908, 2928, 2948, 2968, 2984, 2999, 3020, 3035, 3051, 3069, 3086, 3102, 3119, 3138, 3153, 3167, 3183, 3200, 3214, 3226, 3243, 3254, 3266, 3279, 3295, 3312, 3320, 3325, 3336, 3346, 3363, 3384, 3405, 3423, 3439, 3459, 3476, 3495, 3517, 3544, 3562, 3584, 3594, 3613, 3628, 3641, 3662, 3676, 3689, 3697, 3711, 3724, 3740, 3756, 3775, 3793, 3812, 3831, 3848, 3867, 3886, 3910, 3930, 3934}
