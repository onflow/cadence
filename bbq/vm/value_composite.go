...
//
//func (v *CompositeValue) StaticType(ctx interpreter.StaticTypeAndReferenceContext) bbq.StaticType {
...
//}
//
//func (v *CompositeValue) GetField(gauge common.MemoryGauge, name string) Value {
...
//			Value: VMValueToInterpreterValue(transferContext, v),
//		})
//	}
//
...
//				vmValue.Transfer(transferContext, address, remove, nil)
//
...
//		)
//
//		config.CheckInvalidatedResourceOrResourceReference(value, EmptyLocationRange)
//
//		resume = f(
