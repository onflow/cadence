...
func TestPrintInstruction(t *testing.T) {
	...
	instructions := map[string][]byte{
		...
		"Invoke typeArgs:[772, 1286] argTypes:[1800, 2304, 258]": {
			byte(Invoke), 0, 2, 3, 4, 5, 6, 0, 3, 7, 8, 9, 0, 1, 2, 3,
		},
